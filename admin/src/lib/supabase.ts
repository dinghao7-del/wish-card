  ...
  public: {
    Tables: {
      ...
      commercial_resources: {
        Row: {
          id: string;
          category: 'education' | 'travel' | 'healthcare';
          kind: 'course' | 'camp' | 'learning_tool' | 'parent_child_trip' | 'medical_service' | 'care_service';
          title: string;
          ...
          holiday_play_scales: string[] | null;
          holiday_play_modes: string[] | null;
          caregiver_load_tags: string[] | null;
          budget_level_tags: string[] | null;
          effort_level_tags: string[] | null;
