-- ============================================
-- 心愿模板库种子数据
-- 包含：娱乐时光、美食享受、户外探索、创意手工、社交聚会、购物消费、特殊特权
-- ============================================
...
'2小时', ARRAY['电影', '爆米花', '零食', '毯子'], ARRAY['亲子 bonding', '审美体验', '策划能力'],
'system', true, 3, true),
...
'户外探索', NULL, '🎢', 'https://images.unsplash.com/photo-156925007 acclaimed8-5c65c0e72128?w=400',
...
('reward', '露营体验', '在 backyard 或营地露营一晚',
...
'特殊特权', NULL, '🌙', 'https://images.unsplash.com/photo-1488441770600-cadcc8a63f18?w=400',
